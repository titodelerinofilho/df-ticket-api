...
final class Version20260521201803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT FK_E52FFDEED0494586 FOREIGN KEY (user_identifier) REFERENCES users (identifier) NOT DEFERRABLE');
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT FK_E52FFDEE2FC05A45 FOREIGN KEY (event_identifier) REFERENCES events (identifier) NOT DEFERRABLE');
        $this->addSql('ALTER TABLE organizers ADD CONSTRAINT FK_D29B3BFC25441A2F FOREIGN KEY (owner_identifier) REFERENCES users (identifier) NOT DEFERRABLE');
        $this->addSql('ALTER TABLE ticket_types ADD CONSTRAINT FK_7100EABB2FC05A45 FOREIGN KEY (event_identifier) REFERENCES events (identifier) NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE events ADD CONSTRAINT FK_5387574A130A16A9 FOREIGN KEY (organizer_identifier) REFERENCES organizers (identifier) NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE permissions ADD CONSTRAINT FK_2DEDCC6FF81AE946 FOREIGN KEY (role_identifier) REFERENCES roles (identifier) NOT DEFERRABLE');
        $this->addSql('ALTER TABLE permissions ADD CONSTRAINT FK_2DEDCC6FCE11A1C1 FOREIGN KEY (action_list_identifier) REFERENCES action_lists (identifier) NOT DEFERRABLE');
    ...
    {
        $this->addSql('ALTER TABLE orders DROP CONSTRAINT FK_E52FFDEED0494586');
        $this->addSql('ALTER TABLE orders DROP CONSTRAINT FK_E52FFDEE2FC05A45');
        $this->addSql('ALTER TABLE organizers DROP CONSTRAINT FK_D29B3BFC25441A2F');
        $this->addSql('ALTER TABLE ticket_types DROP CONSTRAINT FK_7100EABB2FC05A45');
        $this->addSql('DROP TABLE orders');
        $this->addSql('DROP TABLE organizers');
        $this->addSql('DROP TABLE ticket_types');
        $this->addSql('ALTER TABLE events DROP CONSTRAINT FK_5387574A130A16A9');
        ...
        $this->addSql('ALTER TABLE permissions DROP CONSTRAINT FK_2DEDCC6FF81AE946');
        $this->addSql('ALTER TABLE permissions DROP CONSTRAINT FK_2DEDCC6FCE11A1C1');
